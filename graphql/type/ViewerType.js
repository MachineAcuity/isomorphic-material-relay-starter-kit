...
export default new GraphQLObjectType( {
  ...
  fields: {
    ...
    Ensayos: {
      ...
      args: { ...connectionArgs },
      resolve: ( obj, { ...args }, { rootValue: {user_id, objectManager} } ) => objectManager.getListBy( 'Ensayo', 'Ensayo_User_id', user_id.toString( ) ).then( ( arrEnsayos ) => connectionFromArray( arrEnsayos, args ) )
    },
    Ensayo: {
      type: EnsayoType,
